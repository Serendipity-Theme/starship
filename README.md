...
Copy a TOML file to `~/.config/starship.toml` and set `palette`.

Available files: `starship-midnight.toml`, `starship-morning.toml`, `starship-sunset.toml`.
